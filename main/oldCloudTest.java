...
public class oldCloudTest {
	...
	/**
	 * Executa testes JUnit distribuídos por métodos
	 * 
	 * @author Gustavo Sávio - saviojp@gmail.com
	 * @param String
	 * @return String
...
//			Method[] average = new Method[methods.length / 2];
//			Method[] average2 = new Method[methods.length / 2];
//
//			System.arraycopy(methods, 0, average, 0, methods.length / 2);
//
//			System.arraycopy(methods, methods.length / 2, average2, 0,
//					methods.length / 2);
//
//			for (Method m : average) {
